            ...
            <div class="card card-statistics h-100">
                <div class="card-body">
                    ...
                    {{-- @can('create invoice') --}}
                     <div class="row">
                        <div class="col mb-3">
                            <a href="{{route('invoices.create')}}" class="btn btn-success" role="button" aria-pressed="true">{{__('website/invoice.create-invoice')}}</a>
                        </div>
                    </div>
                    {{-- @endcan --}}
                    ...
                    <div class="table-responsive">
                        <table id="datatable" class="table table-striped table-bordered p-0 text-center table-hover">
                            ...
                            <tr>
                                <th>#</th>
                                <th style="font-family: 'Cairo', sans-serif; ">{{__('website/invoice.invoice-num')}}</th>
                                <th style="font-family: 'Cairo', sans-serif; ">{{__('website/invoice.invoice-date')}}</th>
                                <th style="font-family: 'Cairo', sans-serif; ">{{__('website/invoice.category')}}</th>
                                <th style="font-family: 'Cairo', sans-serif; "> {{__('website/invoice.product')}} </th>
                                <th style="font-family: 'Cairo', sans-serif; ">{{__('website/invoice.price')}}</th>
                                <th style="font-family: 'Cairo', sans-serif; ">{{__('website/invoice.discount')}}</th>
                                <th style="font-family: 'Cairo', sans-serif; ">{{__('website/invoice.tax-rate')}}</th>
                                <th style="font-family: 'Cairo', sans-serif; ">{{__('website/invoice.tax-value')}}</th>
                                <th style="font-family: 'Cairo', sans-serif; ">{{__('website/invoice.tax-status')}}</th>
                                <th style="font-family: 'Cairo', sans-serif; ">{{__('website/invoice.total')}}</th>
                                <th style="font-family: 'Cairo', sans-serif; ">{{__('website/invoice.operation')}}</th>
                                <th style="font-family: 'Cairo', sans-serif; ">{{__('website/invoice.print')}}</th>
                            </tr>
                            </thead>
                            <tbody>
