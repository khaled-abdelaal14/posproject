...
@section('title')
{{ trans('backend/main_sidebar.dashboard') }}
...
<div class="page-title">
    <div class="row">
        <div class="col-sm-6">
            ...
            " class="mb-0"> {{ trans('backend/main_sidebar.dash') }}</h4>
        </div>
        <div class="col-sm-6">
          <ol class="breadcrumb pt-0 pr-0 float-left float-sm-right">
            <li class="breadcrumb-item" style="font-family: 'Cairo', sans-serif;
            "><a href="{{route('dashboard')}}" class="default-color">{{ trans('backend/main_sidebar.dashboard') }}</a></li>
            <li class="breadcrumb-item active" style="font-family: 'Cairo', sans-serif;
            ">{{ trans('backend/main_sidebar.dash') }}</li>
          </ol>
        </div>
      </div>
  </div>
